...
export const remainingStructures: RemainingStructure[] = [
  ...
  },
  {
    ...
    name: "SharedText",
    module: "text_kernel",
    tagline: "SharedText applies SharedSequence ordering to written symbols.",
    ...
    story: "SharedText uses the same ordering rule as SharedSequence, but applies it to text.",
