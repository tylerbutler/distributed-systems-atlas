...
export const remainingStructures: RemainingStructure[] = [
  ...
  },
  {
    ...
    name: "SharedText",
    module: "text_kernel",
    tagline: "Alice and Bob add words to the same field note without losing either edit.",
    rule: "Give each written symbol its own mark, so both additions stay even when the hikers type at the same place.",
